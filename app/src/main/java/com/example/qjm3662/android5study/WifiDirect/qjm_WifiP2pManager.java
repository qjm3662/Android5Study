...
public class qjm_WifiP2pManager {
    ...
    private android.net.wifi.p2p.WifiP2pManager manager;
     ...
     */
    public qjm_WifiP2pManager(Context context, android.net.wifi.p2p.WifiP2pManager.PeerListListener listListener) {
        this.context = context;
        this.flag_where = WifiDirectBroadCastReceiver.FLAG_FROM_SEND_ACTIVITY;
        manager = (android.net.wifi.p2p.WifiP2pManager) context.getSystemService(Context.WIFI_P2P_SERVICE);
        channel = manager.initialize(context, context.getMainLooper(), null);
        receiver = new WifiDirectBroadCastReceiver(flag_where, manager, channel, ((Activity)context), listListener);

        intentFilter = new IntentFilter();
        intentFilter.addAction(android.net.wifi.p2p.WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION);
        intentFilter.addAction(android.net.wifi.p2p.WifiP2pManager.WIFI_P2P_PEERS_CHANGED_ACTION);
        intentFilter.addAction(android.net.wifi.p2p.WifiP2pManager.WIFI_P2P_CONNECTION_CHANGED_ACTION);
        intentFilter.addAction(android.net.wifi.p2p.WifiP2pManager.WIFI_P2P_THIS_DEVICE_CHANGED_ACTION);
        registerReceiver();
        initListener();
    }
     ...
     */
    public qjm_WifiP2pManager(Context context, android.net.wifi.p2p.WifiP2pManager.PeerListListener listListener, Server.ServerListener serverListener) {
        this.context = context;
    ...
    public void Discover() {
        manager.discoverPeers(channel, new android.net.wifi.p2p.WifiP2pManager.ActionListener() {
            @Override
            public void onSuccess() {
