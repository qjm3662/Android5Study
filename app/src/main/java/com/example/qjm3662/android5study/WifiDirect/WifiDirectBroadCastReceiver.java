...
public class WifiDirectBroadCastReceiver extends BroadcastReceiver{
    ...
    public final static int FLAG_FROM_WIFIDIRECTDEMO_ACTIVITY = 111;
                ...
                case WifiP2pManager.WIFI_P2P_PEERS_CHANGED_ACTION:
                    ...
                    switch (flag_where){
                        ...
                        case FLAG_FROM_SEND_ACTIVITY:
                            ...
                            break;
                        case FLAG_FROM_WIFIDIRECTDEMO_ACTIVITY:
                            listListener = ((MyWifiDirectActivity)activity).getPeerListListener();
                            break;
                    }
                    if(manager != null){
                ...
                case WifiP2pManager.WIFI_P2P_CONNECTION_CHANGED_ACTION:
                    ...
                    switch (flag_where){
                        ...
                        case FLAG_FROM_SEND_ACTIVITY:
                            ...
                            break;
                        case FLAG_FROM_WIFIDIRECTDEMO_ACTIVITY:
                            ll = ((MyWifiDirectActivity)activity).getConnectionInfoListener();
                            break;
                    }
